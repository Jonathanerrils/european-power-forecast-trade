...
Full XGBoost remains the most accurate model by a wide margin, but the economic comparison is considerably tighter. Its net P\&L exceeds the seven-day trailing-profile rule by €279.73. Relative to lag-24, the trailing profile captures 80.5\% of Full's €1,437.60 incremental gain. Tier-1 trails the trailing profile by €503.88. Across an exploratory 3-, 7-, 10-, 14-, 21- and 28-day profile family, Full's margin ranges from approximately €279.73 to €492.44; the seven-day specification is the strongest of those simple benchmarks against Full. This shows that a large share of the economic value can be captured by a simple rule that learns the recurring hourly price shape, even though that rule has substantially worse point-forecast MAE than Full XGBoost.
...
The frozen S2--S1 contrast remains positive under this supplementary paired analysis. By contrast, the Full XGBoost advantage over the post-hoc trailing-profile rule is much smaller and its block-bootstrap interval includes zero. Tier-1 is lower than the trailing profile by €503.88, and that post-hoc block-bootstrap interval excludes zero. The monthly S2--S1 decomposition is also uneven: January, February and March contribute €340.52, €367.45 and €300.87 respectively, or about 70.2\% of the full €1,437.60 contrast; April--June contribute €433.70 in total; July is approximately flat at -€4.94.

\paragraph{Threshold-frontier diagnostic.}
Because the frozen pooled-residual uncertainty rule is an abstention threshold, a post-hoc fixed-threshold frontier helps interpret whether its economic behavior is distinctive. A constant threshold of approximately €42.50 produces 160 trades, the same count as S3, and overlaps with S3 on 158 of those trading days; it earns €19,079.26 compared with €19,130.01 for S3. A lower fixed threshold of €20 trades on 187 days, earns €19,919.24, achieves a 96.8\% hit rate and has a worst day of -€8.38. These exploratory results reinforce that the frozen S3 rule mainly implements a time-varying participation hurdle rather than extracting a materially different intraday price pair.
