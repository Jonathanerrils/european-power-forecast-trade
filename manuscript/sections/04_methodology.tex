...
First, two stronger simple economic benchmarks were added. A weekday-aware naive forecast uses lag-24 on Tuesday--Friday and lag-168 on Saturday--Monday. A trailing seven-completed-day hourly mean profile forecasts each local delivery hour by the mean realized price at that same local hour over the preceding seven completed delivery days. Because this second rule requires a seven-day warm-up, comparisons involving it use a common 205-day sample from holdout day 8 onward.

Second, paired daily P\&L differences are summarized using circular moving-block bootstrap intervals with seven-day blocks, 20,000 resamples and fixed seed 20260920. These intervals are post-hoc descriptive inference and are not part of the frozen success criterion.
