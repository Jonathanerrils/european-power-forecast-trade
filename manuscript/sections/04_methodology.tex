...
The primary holdout criterion concerns only \(\Delta_{forecast}\). Full confirmation requires a positive value in the primary cell and all nine sensitivity cells; partial confirmation requires a positive primary cell but fewer than nine positive cells; failure occurs if the primary cell is non-positive. These nine cells are mechanically related sensitivity scenarios, not independent replications: the degradation cost enters as a common within-day pair cost and therefore primarily changes net value and abstention, while efficiency can also affect pair ranking.
...
After the January--July 2026 holdout had been exposed, additional diagnostics were introduced to probe the strength and interpretation of the frozen results. These analyses are explicitly supplementary and do not redefine the original confirmation rule.
