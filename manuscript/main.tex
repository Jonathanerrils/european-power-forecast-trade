...
\journal{Journal target to be selected}
...
\address[inst1]{Affiliation to be inserted}
\address[inst2]{Affiliation to be inserted}
...
The authors declare no competing interests. This statement should be updated if necessary before submission.

\section*{Funding}
Funding information to be inserted before submission.

\section*{Declaration of generative AI and AI-assisted technologies in the writing process}
During preparation of this manuscript, the authors used ChatGPT to assist with language editing, manuscript organization and LaTeX preparation. The underlying research design, code, data analysis, interpretation and final verification remain the responsibility of the authors. This statement should be adapted to the policy of the target journal at submission.
